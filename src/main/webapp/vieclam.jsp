				...
				<div class="category">
					...
					<div class="subcategory">
						<ul class="list-subcategory">
							<li class="sub-item"><a href="vieclamController">Tất cả</a></li>
						<%ArrayList<linhvucbean> dslv = new ArrayList<>(); 
						 dslv = (ArrayList<linhvucbean>) request.getAttribute("dslv");
						 for(linhvucbean lv: dslv) { %> 
						 	<li class="sub-item"><a href="vieclamController?search-input=<%=lv.getMalv()%>"><%=lv.getTenlv() %></a></li>
						<%   
						 }
						%>
				...
				<div class="category">
					...
					<div class="subcategory">
						...
						for(nhatdbean ntd: dsntd) { %> 
					 		<li class="sub-item"><a href="vieclamController?search-input=<%=ntd.getTenntd()%>"><%=ntd.getTenntd() %></a></li>
						<%   
						 }
						%>
						</ul>
				...
				<div class="list-heading-job">
					<div class="layer-heading">
						<ul class="list-ht-job">
							<li class="list-item all active"><a href="vieclamController">Tất cả công việc (<%=dsvlct.size() %>)</a></li>
						</ul>
					</div>
					
					<form class="search-box-job" method="post" action="vieclamController">
				  ...
				  <div class="row-content">
						<a class="job-link" href="#">
							...
							<div class="apply-form">
									...
									<a class="apply-btn" href="applyController?mv=<%=vl.getMav()%>">Apply</a>
