...
<body>
	...
	<%ArrayList<nhatdbean> dsntd = (ArrayList<nhatdbean>) request.getAttribute("dsntd"); %>
			...
			<div class="job-content">
				<div class="list-heading-job">
					<div class="layer-heading">
						<ul class="list-ht-job">
							<li class="list-item all active"><a href="dsntd">Danh sách nhà tuyển dụng (<%=dsntd.size() %>)</a></li>
						</ul>
					</div>
				...
				for(nhatdbean ntd: dsntd) { %>
				  <div class="row-content-2">
						...
						<div class="user-info">
							<img class="anh" src="${pageContext.request.contextPath}/images/<%=ntd.getAnh()%>"/>
							<div class="info-us ntd">
								<span class="mand mb">ID: <%=ntd.getMantd() %></span>
								<span class="ten mb"><%=ntd.getTenntd() %></span>
