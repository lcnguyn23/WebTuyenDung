...
/**
 * Servlet implementation class thongtinviecController
 */
@WebServlet("/thongtinviecController")
public class thongtinviecController extends HttpServlet {
  private static final long serialVersionUID = 1L;

  /**
   * @see HttpServlet#HttpServlet()
   */
  public thongtinviecController() {
    super();
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (nd == null) {
      ...
      dsvlct = vlctbo.getviecdaapply2(nd.getMand());
      if (key != null) {
      ...
      RequestDispatcher rd = request.getRequestDispatcher("thongtinviec.jsp");
