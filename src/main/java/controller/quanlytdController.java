...
/**
 * Servlet implementation class quanlytdController
 */
@WebServlet("/quanlytdController")
public class quanlytdController extends HttpServlet {
  private static final long serialVersionUID = 1L;

  /**
   * @see HttpServlet#HttpServlet()
   */
  public quanlytdController() {
    super();
